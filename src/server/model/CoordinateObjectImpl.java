...
public abstract class CoordinateObjectImpl implements CoordinateObject {
	 ...
	 * @param size  : size of the CoordinateObject (can be consider like the
	 *              CoordinateObject area)
	...
	/**
	 * Method to apply the movement mechanic on this cell, depending of the speed
	 * vector
	 */
	@Override
