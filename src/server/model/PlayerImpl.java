...
public class PlayerImpl implements Player {
	...
	/**
	 * Method to get the position of the player on X coordinate ( globally equals to
	 * it cells position average)
	 * 
	 * @return X position
	 */
	@Override
	...
	/**
	 * Method to get the position of the player on Y coordinate ( globally equals to
	 * it cells position average)
	 * 
	 * @return Y position
	 */
	...
	/**
	 * Method to calculate the coordinate of the player, to avoid multiple
	 * calculation each time that we need this coordinates
	 */
	@Override
