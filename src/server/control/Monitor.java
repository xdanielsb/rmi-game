...
public class Monitor {
	...
	/**
	 * Method to get all the players to add on the board (will remove all the
	 * waiting players from the monitor)
	 * 
	...
	/**
	 * Method to get all the players to remove on the board (will remove all the
	 * waiting players from the monitor)
	 * 
	 * @return the list of player to add
	 */
